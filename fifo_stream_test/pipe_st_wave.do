...
add wave -noupdate -radix decimal /stream_pipeline_adapter_tb/uut/genblk2/storage_int/item_count
add wave -noupdate /stream_pipeline_adapter_tb/uut/genblk2/storage_int/addr_delta_is_one
add wave -noupdate /stream_pipeline_adapter_tb/uut/genblk2/storage_int/mem_valid
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3335000 ps} 0} {{Cursor 2} {6158439 ps} 0}
...
update
WaveRestoreZoom {3235207 ps} {3776541 ps}
