...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=9 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr add_sub clock dataa datab result
...
module  fpm_add_altbarrel_shift_ltd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fpm_add_altbarrel_shift_ltd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altbarrel_shift_aeb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fpm_add_altbarrel_shift_aeb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fpm_add_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fpm_add_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fpm_add_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //fpm_add_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fpm_add_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fpm_add_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //fpm_add_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fpm_add_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fpm_add_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	fpm_add_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //fpm_add_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fpm_add_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	fpm_add_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //fpm_add_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fpm_add_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fpm_add_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //fpm_add_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	fpm_add_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	fpm_add_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //fpm_add_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fpm_add_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fpm_add_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //fpm_add_altpriority_encoder_qb6
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //fpm_add_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	fpm_add_altpriority_encoder_nh8   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	fpm_add_altpriority_encoder_nh8   altpriority_encoder28
	( 
	.data(data[3:2]),
...
endmodule //fpm_add_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	fpm_add_altpriority_encoder_qh8   altpriority_encoder25
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	fpm_add_altpriority_encoder_qh8   altpriority_encoder26
	( 
	.data(data[7:4]),
...
endmodule //fpm_add_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	fpm_add_altpriority_encoder_vh8   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	fpm_add_altpriority_encoder_vh8   altpriority_encoder24
	( 
	.data(data[15:8]),
...
endmodule //fpm_add_altpriority_encoder_fj8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //fpm_add_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fpm_add_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	fpm_add_altpriority_encoder_n28   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //fpm_add_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fpm_add_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	fpm_add_altpriority_encoder_q28   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //fpm_add_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fpm_add_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	fpm_add_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //fpm_add_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altpriority_encoder_e48
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fpm_add_altpriority_encoder_fj8   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	fpm_add_altpriority_encoder_f48   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //fpm_add_altpriority_encoder_e48

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 458 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fpm_add_altfp_add_sub_akk
	( 
	aclr,
	add_sub,
	clock,
...
`endif
	...
	fpm_add_altbarrel_shift_ltd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fpm_add_altbarrel_shift_aeb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	fpm_add_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	fpm_add_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //fpm_add_altfp_add_sub_akk
//VALID FILE
...
module fpm_add (
	...
	fpm_add_altfp_add_sub_akk	fpm_add_altfp_add_sub_akk_component (
				.aclr (aclr),
				.add_sub (add_sub),
				.clock (clock),
				.datab (datab),
...
// Retrieval info: CONSTANT: PIPELINE NUMERIC "9"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fpm_add.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpm_add.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpm_add.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpm_add.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpm_add_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL fpm_add_bb.v TRUE
