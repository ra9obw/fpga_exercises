...
} -radix hexadecimal /fifo_stream_test_tb/uut/rcv_fifo_ch/data
add wave -noupdate -expand -group {FIFO
} /fifo_stream_test_tb/uut/rcv_fifo_ch/wrreq
add wave -noupdate -expand -group {FIFO
...
WaveRestoreCursors {{Cursor 1} {975000 ps} 0} {{Cursor 2} {1005000 ps} 0}
...
update
WaveRestoreZoom {1839097700 ps} {1839247490 ps}
